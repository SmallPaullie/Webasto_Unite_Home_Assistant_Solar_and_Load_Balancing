...
1. Copy the modbus_webasto.yaml file to the 'homeassistant/packages' folder (create folder if not yet exists)
...
5. If wanted/needed (I recomment!) use supplied example HA View (TAB) 'view_webasto.yaml' for managing EV charger
